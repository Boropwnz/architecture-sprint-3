...
- Добавлено больше домейнов, поддомейнов и контекстов [As Is] в Задание 1.
- Добавлен новый дополнительный список домейнов [To Be] в Задание 1.
- Обновлена ER диаграмма в задании 3: добавлены понятия House и Family. House может иметь несколько Family. User может не иметь Family.
