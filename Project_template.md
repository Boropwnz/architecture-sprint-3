...
- Добавлено больше домейнов, поддомейнов и контекстов [As Is] в Задание 2.
- Добавлен новый дополнительный список домейнов [To Be] в Задание 2.
- Обновлена ER диаграмма: добавлены понятия House и Family. House может иметь несколько Family. User может не иметь Family.
